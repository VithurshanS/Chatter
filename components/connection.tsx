...
export function Connection({ id }: { id: string }) {
    const [connection, setConnection] = useState<userType[]>([]);
    const [friendname, setfn] = useState<string>("");
    const [frie, setfrie] = useState<userType>();
                ...
                <div className="mt-6 w-full">
                    ...
                    {connection?.length > 0 ? (
                        <div className="space-y-3">
                            {connection.map((element: userType) => (
